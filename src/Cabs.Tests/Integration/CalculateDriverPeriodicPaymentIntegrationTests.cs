...
public class CalculateDriverPeriodicPaymentIntegrationTests : IAsyncLifetime
{
    ...
    public async Task ShouldCalculateMothlyPayment()
    {
        ...
        await Fixtures.CreateDriverFee(driver, DriverFee.FeeTypes.Flat, 10);

        await Fixtures.TransitOn(driver, 13, 2020, Month.September, 29);
        await Fixtures.TransitOn(driver, 21, 2020, Month.September, 30);

        await Fixtures.TransitOn(driver, 34, 2020, Month.October, 1); // 24
        await Fixtures.TransitOn(driver, 55, 2020, Month.October, 2); // + 45
        await Fixtures.TransitOn(driver, 89, 2020, Month.October, 30); // + 79
        await Fixtures.TransitOn(driver, 144, 2020, Month.October, 31); // + 134
        await Fixtures.TransitOn(driver, 233, 2020, Month.November, 1); // + 223 = 505

        await Fixtures.TransitOn(driver, 377, 2020, Month.November, 2);
    ...
    public async Task ShouldCalculateYearlyPayment()
    {
        ...
        await Fixtures.TransitOn(driver, 13, 2019, Month.December, 30);
        await Fixtures.TransitOn(driver, 21, 2019, Month.December, 31);

        await Fixtures.TransitOn(driver, 34, 2020, Month.January, 1); // 24
        await Fixtures.TransitOn(driver, 55, 2020, Month.January, 2); // + 45 = 69
        await Fixtures.TransitOn(driver, 89, 2020, Month.December, 30); // 79
        await Fixtures.TransitOn(driver, 144, 2020, Month.December, 31); // + 134

        await Fixtures.TransitOn(driver, 233, 2021, Month.January, 1); //  + 223 = 436
        await Fixtures.TransitOn(driver, 377, 2021, Month.January, 2);
